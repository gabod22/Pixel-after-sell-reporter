...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 547, 638))
        ...
        self.menuArchivo.addAction(self.accionLoginKordata)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.TxtNot.setText(QCoreApplication.translate("MainWindow", u"NOT", None))
